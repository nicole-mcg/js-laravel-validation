...
describe('Rules', function () {
  function createRuleTests(rule, tests) {
    describe("".concat(rule, " rule"), function () {
      tests.forEach(function (test) {
        var desc = test.desc,
            _test$ruleParams = test.ruleParams,
            ruleParams = _test$ruleParams === void 0 ? {} : _test$ruleParams,
            result = test.result,
            _test$skip = test.skip,
            skip = _test$skip === void 0 ? false : _test$skip,
            _test$value = test.value,
            value = _test$value === void 0 ? undefined : _test$value,
            _test$values = test.values,
            values = _test$values === void 0 ? undefined : _test$values,
            _test$params = test.params,
            params = _test$params === void 0 ? undefined : _test$params,
            _test$nullable = test.nullable,
            nullable = _test$nullable === void 0 ? false : _test$nullable;
        ...
        var testName = "can ".concat(result ? 'allow' : 'deny', " a ").concat(desc);
        ...
        var testFunc = function testFunc() {
          ...
          var realResult = _rules.default[rule](ruleParams);

          if (realResult != result) {
            expect(test).toBe("Rule test failed: result=".concat(result, " realResult=").concat(realResult)); //expect(test).toBe(false);
          }
  ...
  var createNotEmptyTests = function createNotEmptyTests() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        _ref$isZeroEmpty = _ref.isZeroEmpty,
        isZeroEmpty = _ref$isZeroEmpty === void 0 ? false : _ref$isZeroEmpty,
        _ref$isFalseEmpty = _ref.isFalseEmpty,
        isFalseEmpty = _ref$isFalseEmpty === void 0 ? true : _ref$isFalseEmpty;
  ...
  createRuleTests('accepted', createNotEmptyTests({
    isZeroEmpty: true
  }));
